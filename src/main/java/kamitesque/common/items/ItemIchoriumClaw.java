...
public class ItemIchoriumClaw extends ItemKTBase implements IWarpingGear {

    public ItemIchoriumClaw(String name, String... variants) {
        super(name);
    ...
    public boolean hitEntity(@NotNull ItemStack stack, @NotNull EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (!attacker.world.isRemote) {
            ...
            if (target instanceof EntityPlayer || BanishUtils.isBanished(target) || !target.isNonBoss()) {
                return false;
            }
